                        ...
                        <div class="content-group">
                            ...
                            <div class="group-content">
                                <div class="button-box" v-if="!isPassword">
                                    <a href="" class="btn btn-black lg h50 bdr4 flex-1 f18 f-lg-14"
                                       @click.prevent="showPassword">비밀번호 변경</a>
                                </div>
                ...
                <li v-if="user.company">
                    ...
                    <div class="write-content">
                        ...
                        <div class="content-group">
                            ...
                            <div class="group-content">
                                <div class="input-box">
                                    <input type="text" placeholder="대표자 연락처를 입력해주세요." v-model="form.company_contact"
                                           @input="clearLetter">
                        ...
                        <div class="content-group">
                            ...
                            <div class="group-content">
                                <input-address address="company_address" address_detail="company_address_detail"
                                               address_zipcode="company_address_zipcode"
                                               @change="(data) => form[data.name] = data.value" :form="form"/>
                        ...
                        <div class="content-group">
                            ...
                            <div class="group-content">
                                <input-images :default="user.company.img ? [user.company.img] : ''"
                                              @change="data => form.company_img = data"/>
                    ...
                    <div class="write-content">
                            ...
                            <div class="group-content">
                                <div class="flex flex-vc mt25 mt-lg-15">
                                    <div class="check-basic-box mr60 mr-lg-30">
                                        <input type="radio" name="radio01" value="1" id="radio01_01"
                                               v-model="form.agree_sms_promotion">
                                        <label for="radio01_01"><p>동의</p></label>
                                    </div>
                                    <div class="check-basic-box">
                                        <input type="radio" name="radio01" value="0" id="radio01_02"
                                               v-model="form.agree_sms_promotion">
                        ...
                        <div class="content-group">
                            ...
                            <div class="group-content">
                                <div class="flex flex-vc mt25 mt-lg-15">
                                    <div class="check-basic-box mr60 mr-lg-30">
                                        <input type="radio" name="radio02" value="1" id="radio02_01"
                                               v-model="form.agree_email_promotion">
                                        <label for="radio02_01"><p>동의</p></label>
                                    </div>
                                    <div class="check-basic-box">
                                        <input type="radio" name="radio02" value="0" id="radio02_02"
                                               v-model="form.agree_email_promotion">
