    ...
    <div class="admin-right">
        <div class="admin-right-container">
                    ...
                    <tr v-for="item in items.data" :key="item.id">
                        ...
                        <td>
                            <div class="table-button-box">
                                <nuxt-link :to="`/admin/providers/create?id=${item.id}`" class="active">조회</nuxt-link>
            ...
            <div class="flex flex-vc flex-tj mt32">
                ...
                <div class="button-box">
                    <nuxt-link to="/admin/providers/create" class="btn btn-blue px45">등록</nuxt-link>
                </div>
            </div>
        </div>
    </div>
...
export default {
    ...
    methods: {
        ...
        remove(item){
            ...
            if(confirmed)
                this.form.delete("/api/admin/providers/" + item.id)
                        .then(response => {
        ...
        up(item){
            ...
            if (index > 0) {
                ...
                this.form.patch("/api/admin/providers/" + item.id + "/up");
            }
        },
        ...
        down(item){
            ...
            if (index < this.items.data.length - 1) {
                ...
                this.form.patch("/api/admin/providers/" + item.id + "/down");
        ...
        importExcel(e){
            ...
            this.form.post("/api/admin/providers/import")
                    .then(response => {
        ...
        exportExcel(){
            ...
            this.form.post("/api/admin/providers/export")
                    .then(response => {
                        if(response.data){
                            let a = document.getElementById("download");
