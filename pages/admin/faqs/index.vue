    ...
    <div class="admin-right">
        <div class="admin-right-container">
                    ...
                    <tr v-for="item in items.data" :key="item.id">
                        ...
                        <td>
                            <div class="table-button-box">
                                <nuxt-link :to="`/admin/faqs/create?id=${item.id}`" class="active">조회</nuxt-link>
            ...
            <div class="flex flex-vc flex-tj mt32">
                ...
                <div class="button-box">
                    <nuxt-link to="/admin/faqs/create" class="btn btn-blue px45">등록</nuxt-link>
                </div>
            </div>
        </div>
    </div>
...
export default {
    ...
    methods: {
        ...
        remove(item){
            ...
            this.$axios.delete("/api/admin/faqs/" + item.id, {
                params: this.form.data()
            }).then(response => {
