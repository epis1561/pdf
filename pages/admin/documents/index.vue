    ...
    <div class="admin-right">
        <div class="admin-right-container">
                    ...
                    <tr v-for="item in items.data" :key="item.id">
                        ...
                        <td>
                            <div class="table-button-box">
                                <nuxt-link :to="`/admin/documents/create?id=${item.id}`" class="active">조회</nuxt-link>
            ...
            <div class="flex flex-vc flex-tj mt32">
                ...
                <div class="button-box">
                    <nuxt-link to="/admin/documents/create" class="btn btn-blue px45">등록</nuxt-link>
                </div>
            </div>
        </div>
    </div>
...
export default {
    ...
    methods: {
        ...
        filter(){
            ...
            this.$axios.get("/api/admin/documents", {
        ...
        remove(item){
            ...
            this.$axios.delete("/api/admin/documents/" + item.id, {
                params: this.form.data()
            }).then(response => {
